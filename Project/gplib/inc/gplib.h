...
#define D_ALL_NHS		(D_FILE | D_RDONLY | D_DIR | D_ARCHIVE)
...
#if APP_COMAIR_V_EN == 1
#define COMAIR_V_FREQ_0	17000
#define COMAIR_V_FREQ_1	17200
#define COMAIR_V_FREQ_2	17400
#define COMAIR_V_FREQ_3	17600
#define COMAIR_V_FREQ_4	17800
#define COMAIR_V_FREQ_5	18000
#define COMAIR_V_FREQ_6	18200

#define	C_COMAIR_TIMERA_DATA	40000

#define	F0_PRELOAD				0x10000 - (MCLK/2/COMAIR_V_FREQ_0)
#define	F1_PRELOAD				0x10000 - (MCLK/2/COMAIR_V_FREQ_1)
#define	F2_PRELOAD				0x10000 - (MCLK/2/COMAIR_V_FREQ_2)
#define	F3_PRELOAD				0x10000 - (MCLK/2/COMAIR_V_FREQ_3)
#define	F4_PRELOAD				0x10000 - (MCLK/2/COMAIR_V_FREQ_4)
#define	F5_PRELOAD				0x10000 - (MCLK/2/COMAIR_V_FREQ_5)
#define	F6_PRELOAD				0x10000 - (MCLK/2/COMAIR_V_FREQ_6)
...
INT32S record_data_process_comairV(INT32U buf_addr_in, INT32U cblen, INT32U file_offset);
void fn_GPTD8_Init_Start(void);
//=============================================================
//=============================================================
/* Local API */
