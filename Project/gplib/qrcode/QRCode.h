...
//              unsigned char image_type : bit[1]: YUYV / bit[2]: Y only 
//                                         bit[4]: for swap Y image(Y1Y0 Y3Y2..)(for Y only image)
//                                         bit[8]: for sequential Y image(Y0Y1Y2..)(for Y only image)
...
// Image Type //
#define IMAGETYPE_YUYV 			0x1	//for YUYV type image
#define IMAGETYPE_YY_SWAP		0x2	//for Y swap image(Y1Y0 Y3Y2..)(for Y only image)
#define IMAGETYPE_YY_SEQUENTIAL	0x4	//for Y sequential image(Y0Y1Y2..)(for Y only image)
#define IMAGETYPE_COLORINVERSE	0x8	//for white/black inverse pattern
