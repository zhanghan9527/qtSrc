...
#define PU_BM_BRIGHTNESS							0x0001	/* Brightness */
#define PU_BM_CONTRAST								0x0002	/* Contrast */
#define PU_BM_HUE									0x0004	/* Hue */
#define PU_BM_SATURATION							0x0008	/* Saturation */
#define PU_BM_SHARPNESS								0x0010	/* Sharpness */
#define PU_BM_GAMMA									0x0020	/* Gamma */
#define PU_BM_WBTEMP								0x0040	/* White Balance Temperature */
#define PU_BM_WBCOM									0x0080	/* White Balance Component */
#define PU_BM_BLCOM									0x0100	/* Backlight Compensation */
#define PU_BM_GAIN									0x0200	/* Gain */ 
#define PU_BM_PLFREQ								0x0400	/* Power Line Frequency */ 
#define PU_BM_HUEAUTO								0x0800	/* Hue Auto */
#define PU_BM_WBTEMPAUTO							0x1000	/* White Balance Temperature Auto */
#define PU_BM_WBCOMAUTO								0x2000	/* White Balance Component Auto */
#define PU_BM_DMUL									0x4000	/* Digital Multiplier */ 
#define PU_BM_DMULLIM								0x8000	/* Digital Multiplier Limit */ 
#define PU_BM_ANAVSTD								0x010000	/* Analog Video Standard */ 
#define PU_BM_ANAVLOCK								0x020000	/* Analog Video Lock Status */ 
#define PU_BM_CONTRASTAUTO							0x040000	/* Contrast Auto */
