/*
* Purpose: driver layer 1 CMOS sensor interface 
*
* Author: 
*
* Date: 
*
* Copyright Generalplus Technology Inc ALL RIGHTS RESERVED.
*
* Version : 1.00
*
* Revision History :
...
*
* Syntax : void sccb_delay(INT32U i);
*
* Purpose :  delay function
*
* Parameters : <IN> i: delay count
*              <OUT> none
* Return : None
*
* Note :
...
*
* Purpose :  Start of data transmission
*
* Parameters : <IN> none
*              <OUT> none
* Return : None
...
*
* Purpose :  Stop of data transmission
*
* Parameters : <IN> none
*              <OUT> none
* Return : None
...
/*
* Function Name :  sccb_w_phase
*
* Syntax : INT32S sccb_w_phase (INT16U value,INT8U ack);
*
* Purpose :  Phase write process
*
* Parameters : <IN> value:	output data
*					ack: 1:ack	0:nack
*              <OUT> none
* Return : 0: Success
*		  -1: Fail
...
/*
* Function Name :  sccb_r_phase
*
* Syntax : INT16U sccb_r_phase (INT8U phase);
*
* Purpose :  Phase read process
*
* Parameters : <IN> phase:	In phase 2, the nineth bit is ACK.
...
*
* Syntax : INT32S sccb_write (INT8U id,INT32U addr_bits,INT32U addr,INT32U data_bits, INT32U data);
*
* Purpose :  SCCB write register process
*
* Parameters : <IN>	id: Slave ID
*					addr_bits:	Register Address bit number
*					addr:		Register Address
*					data_bits:	Register Data bit number
*					data:		Register Data
*              <OUT> none
* Return : 0: Success
*			-1: Fail
...
*
* Syntax : INT32S sccb_read (INT8U id,INT32U addr_bits,INT32U addr,INT32U data_bits, INT32U data);
*
* Purpose :  SCCB read register process
*
* Parameters : <IN>	id: Slave ID
*					addr_bits:	Register Address bit number
*					addr:		Register Address
...
/*
* Function Name :  sccb_lock
*
* Syntax : void sccb_lock(void);
*
* Purpose :  lock os task scheduling 
*
* Parameters : <IN>	none
*              <OUT> none
* Return : none
...
/*
* Function Name :  sccb_unlock
*
* Syntax : void sccb_unlock(void);
*
* Purpose :  unlock os task scheduling 
*
* Parameters : <IN>	none
*              <OUT> none
* Return : none
...
/*
* Function Name :  HSB0357_Init
*
* Syntax : void HSB0357_Init(INT16S nWidthH, INT16S nWidthV, INT16U uFlag);
*
* Purpose :  HSB0357 Initialization
*
* Parameters : <IN>	nWidthH: Active horizontal width
*					nWidthV: Active vertical height	
*					uFlag: 	 Flag type selection
*              <OUT> none
* Return : none
*
* Note :
...
/*
* Function Name :  OV6680_Init
*
* Syntax : void OV6680_Init(INT16S nWidthH,	 INT16S nWidthV, INT16U uFlag);
*
* Purpose :  OV6680 Initialization
*
* Parameters : <IN>	nWidthH: Active horizontal width
*					nWidthV: Active vertical height	
*					uFlag: 	 Flag type selection
...
/*
* Function Name :  OV9655_Init
*
* Syntax : void OV9655_Init(INT16S nWidthH,	 INT16S nWidthV, INT16U uFlag);
*
* Purpose :  OV9655 Initialization
*
* Parameters : <IN>	nWidthH: Active horizontal width
*					nWidthV: Active vertical height	
*					uFlag: 	 Flag type selection
...
/*
* Function Name :  OV9660_Init
*
* Syntax : void OV9660_Init(INT16S nWidthH,	 INT16S nWidthV, INT16U uFlag);
*
* Purpose :  OV9660 Initialization
*
* Parameters : <IN>	nWidthH: Active horizontal width
*					nWidthV: Active vertical height	
*					uFlag: 	 Flag type selection
...
/*
* Function Name :  OV7680_Init
*
* Syntax : void OV7680_Init(INT16S nWidthH,	 INT16S nWidthV, INT16U uFlag);
*
* Purpose :  OV7680 Initialization
*
* Parameters : <IN>	nWidthH: Active horizontal width
*					nWidthV: Active vertical height	
*					uFlag: 	 Flag type selection
...
*
* Syntax : void OV7670_Init(INT16S nWidthH,	 INT16S nWidthV, INT16U uFlag);
*
* Purpose :  OV7670 Initialization
*
* Parameters : <IN>	nWidthH: Active horizontal width
*					nWidthV: Active vertical height	
*					uFlag: 	 Flag type selection
...
/*
* Function Name :  OV2655_Init
*
* Syntax : void OV2655_Init(INT16S nWidthH,	 INT16S nWidthV, INT16U uFlag);
*
* Purpose :  OV2655 Initialization
*
* Parameters : <IN>	nWidthH: Active horizontal width
*					nWidthV: Active vertical height	
*					uFlag: 	 Flag type selection
...
/*
* Function Name :  OV3640_Init
*
* Syntax : void OV3640_Init(INT16S nWidthH,	 INT16S nWidthV, INT16U uFlag);
*
* Purpose :  OV3640 Initialization
*
* Parameters : <IN>	nWidthH: Active horizontal width
*					nWidthV: Active vertical height	
*					uFlag: 	 Flag type selection
...
/*
* Function Name :  OV5642_Init
*
* Syntax : void OV5642_Init(INT16S nWidthH,	 INT16S nWidthV, INT16U uFlag);
*
* Purpose :  OV5642 Initialization
*
* Parameters : <IN>	nWidthH: Active horizontal width
*					nWidthV: Active vertical height	
*					uFlag: 	 Flag type selection
...
*
* Syntax : void OV7675_Init(INT16S nWidthH,	 INT16S nWidthV, INT16U uFlag);
*
* Purpose :  OV7675 Initialization
*
* Parameters : <IN>	nWidthH: Active horizontal width
*					nWidthV: Active vertical height	
*					uFlag: 	 Flag type selection
...
/*
* Function Name :  OV2643_Init
*
* Syntax : void OV2643_Init(INT16S nWidthH,	 INT16S nWidthV, INT16U uFlag);
*
* Purpose :  OV2643 Initialization
*
* Parameters : <IN>	nWidthH: Active horizontal width
*					nWidthV: Active vertical height	
*					uFlag: 	 Flag type selection
...
/*
* Function Name :  OV2659_Init
*
* Syntax : void OV2659_Init(INT16S nWidthH,	 INT16S nWidthV, INT16U uFlag);
*
* Purpose :  OV2659 Initialization
*
* Parameters : <IN>	nWidthH: Active horizontal width
*					nWidthV: Active vertical height	
*					uFlag: 	 Flag type selection
...
/*
* Function Name :  OID_Sensor_Init
*
* Syntax : void OID_Sensor_Init(INT16S nWidthH,	 INT16S nWidthV);
*
* Purpose :  OID sensor initialization
*
* Parameters : <IN>	nWidthH: Active horizontal width
*					nWidthV: Active vertical height	
*              <OUT> none
...
/*
* Function Name :  BF3710_Init
*
* Syntax : void BF3710_Init(INT16S nWidthH,	 INT16S nWidthV, INT16U uFlag);
*
* Purpose :  BF3710 Initialization
*
* Parameters : <IN>	nWidthH: Active horizontal width
*					nWidthV: Active vertical height	
*					uFlag: 	 Flag type selection
...
/*
* Function Name :  GC0307_Init
*
* Syntax : void GC0307_Init(INT16S nWidthH,	 INT16S nWidthV, INT16U uFlag);
*
* Purpose :  GC0307 Initialization
*
* Parameters : <IN>	nWidthH: Active horizontal width
*					nWidthV: Active vertical height	
*					uFlag: 	 Flag type selection
...
void GC0307_Init (
...
#if 0    
    sccb_write_Reg8Data8(GC0307_ID, 0x83, 0x23);  // ËøôÊòØ0x00ÂØπÂ??ÑGamma
    sccb_write_Reg8Data8(GC0307_ID, 0x84, 0x38);  
    sccb_write_Reg8Data8(GC0307_ID, 0x85, 0x4F);  
    sccb_write_Reg8Data8(GC0307_ID, 0x86, 0x61);  
    sccb_write_Reg8Data8(GC0307_ID, 0x87, 0x72);  
    ...
    sccb_write_Reg8Data8(GC0307_ID, 0x93, 0xFD);
#else                                          
    sccb_write_Reg8Data8(GC0307_ID, 0x83, 0x13);  // ?∏Â?‰∫?x20ÂØπÂ??ÑGamma
    ...
    sccb_write_Reg8Data8(GC0307_ID, 0x94, 0x04);  //ËøôÊòØ0x40ÂØπÂ??ÑGamma
    sccb_write_Reg8Data8(GC0307_ID, 0x95, 0x0E);  
    sccb_write_Reg8Data8(GC0307_ID, 0x96, 0x1B);  
    sccb_write_Reg8Data8(GC0307_ID, 0x97, 0x28);  
    sccb_write_Reg8Data8(GC0307_ID, 0x98, 0x35);  
...
/*
* Function Name :  GC0308_Init
*
* Syntax : void GC0308_Init(INT16S nWidthH,	 INT16S nWidthV, INT16U uFlag);
*
* Purpose :  GC0308 Initialization
*
* Parameters : <IN>	nWidthH: Active horizontal width
*					nWidthV: Active vertical height	
*					uFlag: 	 Flag type selection
...
void GC0308_Init (
	...
	// Whether compression or not?
	if ((nWidthH == 320) && (nWidthV == 240))						// VGA to QVGA
	{
		R_CSI_TG_HRATIO = 0x0102;					// Scale to 1/2
		R_CSI_TG_VRATIO = 0x0102;					// Scale to 1/2
		R_CSI_TG_HWIDTH = 640;					// Horizontal frame width
		R_CSI_TG_VHEIGHT = 480;				// Vertical frame width
	}
	else
	{
		R_CSI_TG_HRATIO = 0;
	...
	sccb_write_Reg8Data8(GC0308_ID, 0x14, 0x13);// change direction  10:normal , 11:H SWITCH,12: V SWITCH, 13:H&V SWITCH
	...
	sccb_write_Reg8Data8(GC0308_ID, 0xd3, 0xA0);		 // ?˙ˆ
...
INT8U GC0308_ReadY(void)
{
	...
	sccb_read_Reg8Data8(GC0308_ID, 0xd4, &value);
	return value; 
}

INT8U GC0308_SetY(INT8U Value)
{
	return sccb_write_Reg8Data8(GC0308_ID, 0xd3, Value); //0x48
}

INT8U GC0308_SetGain(INT8U Value1, INT8U Value2)
{
	sccb_write_Reg8Data8(GC0308_ID, 0xee, Value1);
	sccb_write_Reg8Data8(GC0308_ID, 0xef, Value2);
	return 0;
}
#endif
...
/*
* Function Name :  GC0329_Init
*
* Syntax : void GC0329_Init(INT16S nWidthH,	 INT16S nWidthV, INT16U uFlag);
*
* Purpose :  GC0329 Initialization
*
* Parameters : <IN>	nWidthH: Active horizontal width
*					nWidthV: Active vertical height	
*					uFlag: 	 Flag type selection
...
0x12, 0x13 ,
0x13, 0x58 ,   //50
0x17, 0xad ,	//0 mirrow,	1, UPdown	//af
0x1a, 0x21 ,
0x20, 0x31 ,
0x21, 0xc0 ,
0x22, 0x60 ,
...
0xf0, 0x07 ,
0xf1, 0x01 ,
0x17, 0x15,		//0 mirrow,	1, UPdown	//a9
//*/
...
void GC0329_Init (
	...
	if ((nWidthH == 320) && (nWidthV == 240))						// VGA to QVGA
	{
		...
		R_CSI_TG_HWIDTH = 640;					// Horizontal frame width
		R_CSI_TG_VHEIGHT = 480;				// Vertical frame width
	}else if ((nWidthH == 160) && (nWidthV == 120))						// VGA to QQVGA
	{
	...
	while(1){
		if(Gc0329_640x480[2*i]==0) break;
		else{
			sccb_write_Reg8Data8(GC0329_ID, Gc0329_640x480[2*i], Gc0329_640x480[2*i+1]);
			i++;
		}
	}
	//Change_SensorMode(10);
...
INT8U GC0329_ReadY(void)
{
	INT8U value;
	
	sccb_read_Reg8Data8(GC0329_ID, 0xd4, &value);
	return value; 
}

INT8U GC0329_SetY(INT8U Value)
{
	return sccb_write_Reg8Data8(GC0329_ID, 0xd3, Value); //0x48
}

INT8U GC0329_SetGain(INT8U Value1, INT8U Value2)
{
	sccb_write_Reg8Data8(GC0329_ID, 0xee, Value1);
	sccb_write_Reg8Data8(GC0329_ID, 0xef, Value2);
	return 0;
}
#endif


#ifdef	__GC2145_DRV_C__


const INT8U GC2155_Setting[]={
	/////20140331
...
const INT8U GC2155_720P_Setting[]={
	/////20140331
...
void GC2145_Init (
	...
	sccb_init();
	sccb_delay(200);
	sccb_write_Reg8Data8(GC2145_ID, 0x12, 0x80);

	i=0;
	if(nWidthH == 1600 )
	{
		while(1){
			u8_r=GC2155_Setting[2*i];
			u8_d=GC2155_Setting[2*i+1];
			if(u8_r==0 && u8_d==0) break;
			ret=sccb_write_Reg8Data8(GC2145_ID, u8_r, u8_d);
			if(ret==-1) break;
			i++;
		}
	}
...
#if (defined _DRV_L1_MIPI) && (_DRV_L1_MIPI == 1)  
/*
* Function Name :  OV3640_MIPI_Init
*
* Syntax : void OV3640_MIPI_Init(INT16S nWidthH,	 INT16S nWidthV, INT16U uFlag);
*
* Purpose :  OV3640 Initialization
*
* Parameters : <IN>	nWidthH: Active horizontal width
...
*
* Syntax : void CSI_Init (INT16S nWidthH, INT16S nWidthV, INT16U uFlag, INT32U uFrmBuf0, INT32U uFrmBuf1);
*
* Purpose :  Initial CMOS sensor
*
* Parameters : <IN>	nWidthH: Active horizontal width
*					nWidthV: Active vertical height	
*					uFlag: 	 Flag type selection
*					uFrmBuf0: Frame buffer index 0
*					uFrmBuf1: Frame buffer index 1
*              <OUT> none
* Return : none
*
* Note :
...
#endif
#ifdef __GC0329_DRV_C_
	GC0329_Init (nWidthH, nWidthV, uFlag);
#endif
#ifdef	__GC2145_DRV_C__
	GC2145_Init (nWidthH, nWidthV, uFlag);
#endif
}
