...
Description	Disable the specified SPI module
Header File	drv_l1_spi.h
Syntax	INT32S spi_disable(INT8U spi_num)
Parameters	SPI_0 or SPI_1
Return Values	STATUS_OK
			STATUS_FAIL
*/
...
/*
Function Name	spi_clk_rate_set
Description	Set SPI clock
Header File	drv_l1_spi.h
Syntax	INT32S spi_clk_rate_set(INT8U spi_num, INT32U clk_rate)
Parameters	spi_num: SPI_0 or SPI_1
			clk_rate: Destined clock
Return Values	STATUS_OK
*/
...
/*
Function Name	spi_cs_by_internal_set
Description	Set CS active by SPI driver
Header File	drv_l1_spi.h
Syntax	void spi_cs_by_internal_set(INT8U spi_num,INT8U pin_num, INT8U active)
Parameters	spi_num: SPI_0 or SPI_1
	pin_num: CS gpio pin number
	active: activer is 1 or 0
Return Values	None
*/
...
/*
Function Name	spi_cs_by_external_set
Description	Set CS active by user
Header File	drv_l1_spi.h
Syntax	void spi_cs_by_external_set(INT8U spi_num)
Parameters	spi_num: SPI_0 or SPI_1
Return Values	None
*/
...
/*
Function Name	spi_transceive_cpu
Description	Master mode transmit and receive data by CPU polling mode
Header File	drv_l1_spi.h
Syntax	INT32S spi_transceive_cpu(INT8U spi_num, INT8U *tx_data, INT32U tx_len, INT8U *rx_data, INT32U rx_len)
Parameters	spi_num: SPI_0 or SPI_1
			*tx_data: Start address of transmit data
			tx_len: Length of transmit data
			*rx_data: Start address of receive data
			rx_len: Length of receive data
Return Values	SPI_BUSY
		STATUS_OK
		STATUS_FAIL
*/
