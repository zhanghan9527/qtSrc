...
#if (defined (BODY_GP22) || defined (BODY_GP19) || defined (BODY_GP12B))
...
extern void FaceDetectKernel_set_detect_obj(void *_WorkMem, ClassifyData *clfdata);

extern void FaceDetectKernel_AddFace(void *WorkMem, int x, int y);



#if defined (BODY_GP12B)
// add by Comi 2013.04.23
extern void FaceDetectKernel_hw_clock_disable(void);
#endif
