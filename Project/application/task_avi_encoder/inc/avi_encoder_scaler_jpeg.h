...
#define AVI_ENCODE_PCM_BUFFER_NO		2	//audio record pcm use buffer number
...
//avi packer buffer
#define FileWriteBuffer_Size			(16+0)*32*1024//16*32*1024		//avi pack buffer size, must multiple 32k 
