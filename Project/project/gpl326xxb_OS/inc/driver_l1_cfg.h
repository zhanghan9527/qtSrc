...
//===========================================================================================//
    ...
    #define SDRAM_END_ADDR              0x7FFFF0
    ...
    #define C_DISPLAY_DEVICE            WINTEK_WDF4827Y          		// Select one of the display device from above list
    #define C_DISPLAY_DEV_HPIXEL        240                     // Set display device horizontal pixel number
    #define C_DISPLAY_DEV_VPIXEL        320                     // Set display device vertical pixel number
...
//	#define	__OV7670_DRV_C__
	...
	//#define	__GC2155_DRV_C__ 
	//#define		__GC0308_DRV_C_
	#define		__GC0329_DRV_C_
	...
	//#define	__OV3640_MIPI_DRV_C__	
		...
		#define CSI_IRQ_MODE			CSI_IRQ_TG_IRQ//CSI_IRQ_PPU_IRQ//
    ...
    #define __GPIO_PAD_DEFINE__
	     ...
	     #define NAND_CS_POS                 NF_CS_AS_BKCS1//NF_CS_AS_BKCS1
         ...
         #define UART_TX_RX_POS              UART_POSFUN_MASK	//UART_TX_IOE2__RX_IOE3
         ...
         //#define SD_POS                      SDC_IOD8_IOD9_IOD10_IOD11_IOD12_IOD13//yegts
         ...
         #define SPI1_POS                    SPI1_RX_IOI3__CLK_IOI1__TX_IOI2
